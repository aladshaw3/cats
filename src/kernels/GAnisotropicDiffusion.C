 ...
 *DGAnisotropicDiffusion kernel for the discontinous Galerkin formulation of advection physics in
 *MOOSE. In order to complete the DG formulation of the advective physics, this kernel must be
 *utilized with every variable that also uses the DGAAnisotropicDiffusion kernel.
 *
...
InputParameters
GAnisotropicDiffusion::validParams()
{
