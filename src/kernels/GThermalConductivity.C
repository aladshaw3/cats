...
Real GThermalConductivity::computeQpResidual()
{
...
Real GThermalConductivity::computeQpJacobian()
{
    return 0.0;
}

Real GThermalConductivity::computeQpOffDiagJacobian(unsigned int jvar)
{
    if (jvar == _Dx_var)
    {
