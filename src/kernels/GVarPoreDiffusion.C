...
Real
GVarPoreDiffusion::computeQpResidual()
{
...
Real
GVarPoreDiffusion::computeQpJacobian()
{
  _Diffusion(0, 0) = _Dx[_qp];
  _Diffusion(0, 1) = 0.0;
  _Diffusion(0, 2) = 0.0;
...
Real
GVarPoreDiffusion::computeQpOffDiagJacobian(unsigned int jvar)
{
  _Diffusion(0, 0) = _Dx[_qp];
  _Diffusion(0, 1) = 0.0;
  _Diffusion(0, 2) = 0.0;
