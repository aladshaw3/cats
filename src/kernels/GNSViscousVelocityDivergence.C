 ...
 *DGNSViscousVelocityDivergence kernel for the discontinous Galerkin formulation of the 'extra'
 *viscous term in compressible Navier-Stokes. This extra term is zero in the case where the
 *divergence of velocity is zero (i.e., in the incompressible case).
 *
...
InputParameters
GNSViscousVelocityDivergence::validParams()
{
...
Real
GNSViscousVelocityDivergence::computeQpResidual()
{
...
Real
GNSViscousVelocityDivergence::computeQpJacobian()
{
  if (_dir == 0)
  {
...
Real
GNSViscousVelocityDivergence::computeQpOffDiagJacobian(unsigned int jvar)
{
