...
InputParameters MicroscaleVariableDiffusionOuterBC::validParams()
{
...
MicroscaleVariableDiffusionOuterBC::MicroscaleVariableDiffusionOuterBC(const InputParameters & parameters)
...
Real MicroscaleVariableDiffusionOuterBC::computeQpJacobian()
{
    _current_diff = _current_diffusion[_qp];
    _upper_diff = _current_diffusion[_qp];
    _lower_diff = _lower_diffusion[_qp];
