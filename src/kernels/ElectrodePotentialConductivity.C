...
InputParameters ElectrodePotentialConductivity::validParams()
{
...
Real ElectrodePotentialConductivity::computeQpResidual()
{
    return _grad_test[_i][_qp]*_conductivity[_qp]*_sol_frac[_qp]*_grad_u[_qp];
}

Real ElectrodePotentialConductivity::computeQpJacobian()
{
    return _grad_test[_i][_qp]*_conductivity[_qp]*_sol_frac[_qp]*_grad_phi[_j][_qp];
}

Real ElectrodePotentialConductivity::computeQpOffDiagJacobian(unsigned int jvar)
{
