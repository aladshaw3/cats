...
InputParameters
MicroscaleDiffusionInnerBC::validParams()
{
...
void
MicroscaleDiffusionInnerBC::calculateFluxes()
{
...
Real
MicroscaleDiffusionInnerBC::computeQpResidual()
{
  calculateFluxes();
...
Real
MicroscaleDiffusionInnerBC::computeQpJacobian()
{
  calculateFluxes();
...
Real
MicroscaleDiffusionInnerBC::computeQpOffDiagJacobian(unsigned int jvar)
{
  calculateFluxes();
  if (jvar == _upper_var)
  {
