...
InputParameters GPhaseThermalConductivity::validParams()
{
...
Real GPhaseThermalConductivity::computeQpResidual()
{
...
Real GPhaseThermalConductivity::computeQpJacobian()
{
    return 0.0;
}

Real GPhaseThermalConductivity::computeQpOffDiagJacobian(unsigned int jvar)
{
    if (jvar == _Dx_var)
    {
