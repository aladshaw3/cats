...
InputParameters
ArrheniusEquilibriumReaction::validParams()
{
...
Real
ArrheniusEquilibriumReaction::computeQpResidual()
{
  return ArrheniusReaction::computeQpResidual();
}

Real
ArrheniusEquilibriumReaction::computeQpJacobian()
{
  return ArrheniusReaction::computeQpJacobian();
}

Real
ArrheniusEquilibriumReaction::computeQpOffDiagJacobian(unsigned int jvar)
{
