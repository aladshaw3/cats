...
InputParameters MicroscaleDiffusion::validParams()
{
...
void MicroscaleDiffusion::calculateFluxes()
{
...
Real MicroscaleDiffusion::computeQpResidual()
{
    calculateFluxes();
    return _test[_i][_qp]*_flux_upper*(_u[_qp] - _upper_neighbor[_qp]) + _test[_i][_qp]*_flux_lower*(_u[_qp] - _lower_neighbor[_qp]);
}

Real MicroscaleDiffusion::computeQpJacobian()
{
    calculateFluxes();
