...
InputParameters ScaledWeightedCoupledSumFunction::validParams()
{
...
ScaledWeightedCoupledSumFunction::ScaledWeightedCoupledSumFunction(const InputParameters & parameters)
...
Real ScaledWeightedCoupledSumFunction::computeQpResidual()
{
  return WeightedCoupledSumFunction::computeQpResidual()*_scale[_qp];
}

Real ScaledWeightedCoupledSumFunction::computeQpJacobian()
{
	return 0.0;
}

Real ScaledWeightedCoupledSumFunction::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (jvar == _scale_var)
  {
