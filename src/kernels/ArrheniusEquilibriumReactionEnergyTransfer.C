...
InputParameters
ArrheniusEquilibriumReactionEnergyTransfer::validParams()
{
...
ArrheniusEquilibriumReactionEnergyTransfer::ArrheniusEquilibriumReactionEnergyTransfer(
    const InputParameters & parameters)
  : ArrheniusReactionEnergyTransfer(parameters), _entropy(getParam<Real>("entropy"))
{
  _beta_for = 0.0;
  _beta_rev = 0.0;
...
Real
ArrheniusEquilibriumReactionEnergyTransfer::computeQpResidual()
{
  return ArrheniusReactionEnergyTransfer::computeQpResidual();
}

Real
ArrheniusEquilibriumReactionEnergyTransfer::computeQpJacobian()
{
  return 0.0;
}

Real
ArrheniusEquilibriumReactionEnergyTransfer::computeQpOffDiagJacobian(unsigned int jvar)
{
