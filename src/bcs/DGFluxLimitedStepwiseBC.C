...
InputParameters DGFluxLimitedStepwiseBC::validParams()
{
...
Real DGFluxLimitedStepwiseBC::newInputValue(Real time)
{
    Real val = _u_input;
...
Real DGFluxLimitedStepwiseBC::computeQpResidual()
{
...
Real DGFluxLimitedStepwiseBC::computeQpJacobian()
{
    _u_input = newInputValue(_t);
    Real r = 0;
