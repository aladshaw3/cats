...
#include "DGPoreDiffFluxLimitedStepwiseBC.h"
 ...
 */
registerMooseObject("catsApp", DGPoreDiffFluxLimitedStepwiseBC);

/*
template<>
InputParameters validParams<DGPoreDiffFluxLimitedStepwiseBC>()
{
    InputParameters params = validParams<DGPoreDiffFluxLimitedBC>();
...
InputParameters DGPoreDiffFluxLimitedStepwiseBC::validParams()
{
...
DGPoreDiffFluxLimitedStepwiseBC::DGPoreDiffFluxLimitedStepwiseBC(const InputParameters & parameters) :
...
Real DGPoreDiffFluxLimitedStepwiseBC::newInputValue(Real time)
{
    Real val = _u_input;
...
Real DGPoreDiffFluxLimitedStepwiseBC::computeQpResidual()
{
    _u_input = newInputValue(_t);
    return DGPoreDiffFluxLimitedBC::computeQpResidual();
}

Real DGPoreDiffFluxLimitedStepwiseBC::computeQpJacobian()
{
    _u_input = newInputValue(_t);
    return DGPoreDiffFluxLimitedBC::computeQpJacobian();
}

Real DGPoreDiffFluxLimitedStepwiseBC::computeQpOffDiagJacobian(unsigned int jvar)
{
    _u_input = newInputValue(_t);
    return DGPoreDiffFluxLimitedBC::computeQpOffDiagJacobian(jvar);
}
