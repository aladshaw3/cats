...
Real
DGFlowMassFluxBC::computeQpResidual()
{
  _u_input = _input[_qp];
  _velocity(0) = _ux[_qp];
  _velocity(1) = _uy[_qp];
...
Real
DGFlowMassFluxBC::computeQpJacobian()
{
  _u_input = _input[_qp];
  _velocity(0) = _ux[_qp];
  _velocity(1) = _uy[_qp];
...
Real
DGFlowMassFluxBC::computeQpOffDiagJacobian(unsigned int jvar)
{
  _u_input = _input[_qp];
  _velocity(0) = _ux[_qp];
  _velocity(1) = _uy[_qp];
