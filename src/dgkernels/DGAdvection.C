 ...
 *	\details This file creates a discontinous Galerkin kernel for advection physics in a given
 ...
 *velocity vector. That vector can be built piecewise by the respective x, y, and z components of a
 *velocity field at a given quadrature point.
 *
