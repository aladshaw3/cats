 ...
 *	\details This file creates a discontinous Galerkin kernel for momentum advection in a given
 *domain. This file is to be used to solve the Navier-Stokes equations for a fluid using
 *discontinous Galerkin methods and shape functions.
 *
...
InputParameters
DGNSMomentumAdvection::validParams()
{
...
Real
DGNSMomentumAdvection::computeQpResidual(Moose::DGResidualType type)
{
  _velocity(0) = _ux[_qp];
  _velocity(1) = _uy[_qp];
  _velocity(2) = _uz[_qp];
...
Real
DGNSMomentumAdvection::computeQpJacobian(Moose::DGJacobianType type)
{
  _velocity(0) = _ux[_qp];
  _velocity(1) = _uy[_qp];
  _velocity(2) = _uz[_qp];
  ...
  switch (type)
  {
    ...
    case Moose::ElementElement:
      if ((_velocity * _normals[_qp]) >= 0.0)
        ...
        jac += (_phi_neighbor[_j][_qp] * _normals[_qp](_dir)) * _density_upwind[_qp] *
               _u_neighbor[_qp] * _test[_i][_qp];
      break;
    ...
    case Moose::NeighborElement:
      if ((_velocity * _normals[_qp]) >= 0.0)
        jac += -(_phi[_j][_qp] * _normals[_qp](_dir)) * _density[_qp] * _u[_qp] *
               _test_neighbor[_i][_qp];
      else
        jac += -(_phi_neighbor[_j][_qp] * _normals[_qp](_dir)) * _density_upwind[_qp] *
               _u_neighbor[_qp] * _test_neighbor[_i][_qp];
      break;
...
Real
DGNSMomentumAdvection::computeQpOffDiagJacobian(Moose::DGJacobianType type, unsigned int jvar)
{
  _velocity(0) = _ux[_qp];
  _velocity(1) = _uy[_qp];
  _velocity(2) = _uz[_qp];
    ...
    switch (type)
    {
      ...
      case Moose::ElementElement:
        if ((_velocity * _normals[_qp]) >= 0.0)
          ...
          r += (_phi_neighbor[_j][_qp] * _normals[_qp](0)) * _density_upwind[_qp] *
               _u_neighbor[_qp] * _test[_i][_qp];
        break;
      ...
      case Moose::NeighborElement:
        if ((_velocity * _normals[_qp]) >= 0.0)
          r += -(_phi[_j][_qp] * _normals[_qp](0)) * _density[_qp] * _u[_qp] *
               _test_neighbor[_i][_qp];
        else
          r += -(_phi_neighbor[_j][_qp] * _normals[_qp](0)) * _density_upwind[_qp] *
               _u_neighbor[_qp] * _test_neighbor[_i][_qp];
    ...
    switch (type)
    {
      ...
      case Moose::ElementElement:
        if ((_velocity * _normals[_qp]) >= 0.0)
          ...
          r += (_phi_neighbor[_j][_qp] * _normals[_qp](1)) * _density_upwind[_qp] *
               _u_neighbor[_qp] * _test[_i][_qp];
        break;
      ...
      case Moose::NeighborElement:
        if ((_velocity * _normals[_qp]) >= 0.0)
          r += -(_phi[_j][_qp] * _normals[_qp](1)) * _density[_qp] * _u[_qp] *
               _test_neighbor[_i][_qp];
        else
          r += -(_phi_neighbor[_j][_qp] * _normals[_qp](1)) * _density_upwind[_qp] *
               _u_neighbor[_qp] * _test_neighbor[_i][_qp];
    ...
    switch (type)
    {
      ...
      case Moose::ElementElement:
        if ((_velocity * _normals[_qp]) >= 0.0)
          ...
          r += (_phi_neighbor[_j][_qp] * _normals[_qp](2)) * _density_upwind[_qp] *
               _u_neighbor[_qp] * _test[_i][_qp];
        break;
      ...
      case Moose::NeighborElement:
        if ((_velocity * _normals[_qp]) >= 0.0)
          r += -(_phi[_j][_qp] * _normals[_qp](2)) * _density[_qp] * _u[_qp] *
               _test_neighbor[_i][_qp];
        else
          r += -(_phi_neighbor[_j][_qp] * _normals[_qp](2)) * _density_upwind[_qp] *
               _u_neighbor[_qp] * _test_neighbor[_i][_qp];
      ...
      case Moose::NeighborNeighbor:
        if ((_velocity * _normals[_qp]) >= 0.0)
          r += -(_phi_neighbor[_j][_qp] * _normals[_qp](2)) * _density[_qp] * _u[_qp] *
               _test_neighbor[_i][_qp];
        else
          r += -(_phi_neighbor[_j][_qp] * _normals[_qp](2)) * _density_upwind[_qp] *
               _u_neighbor[_qp] * _test_neighbor[_i][_qp];
    ...
    switch (type)
    {
      ...
      case Moose::ElementElement:
        if ((_velocity * _normals[_qp]) >= 0.0)
          ...
          r += (_velocity_upwind * _normals[_qp]) * _phi_neighbor[_j][_qp] * _u_neighbor[_qp] *
               _test[_i][_qp];
        break;
