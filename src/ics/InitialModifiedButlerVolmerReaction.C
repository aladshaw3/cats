...
InputParameters
InitialModifiedButlerVolmerReaction::validParams()
{
...
InitialModifiedButlerVolmerReaction::InitialModifiedButlerVolmerReaction(
...
Real
InitialModifiedButlerVolmerReaction::oxidation_rate_fun()
{
...
Real
InitialModifiedButlerVolmerReaction::reduction_rate_fun()
{
  if (useEquilibriumPotential == true)
  {
...
Real
InitialModifiedButlerVolmerReaction::oxidation_exp_fun()
{
...
Real
InitialModifiedButlerVolmerReaction::reduction_exp_fun()
{
...
Real
InitialModifiedButlerVolmerReaction::reduction_state()
{
  Real prod = 1.0;
  for (unsigned int i = 0; i < _reduced.size(); ++i)
  {
...
Real
InitialModifiedButlerVolmerReaction::oxidation_state()
{
  Real prod = 1.0;
  for (unsigned int i = 0; i < _oxidized.size(); ++i)
  {
...
Real
InitialModifiedButlerVolmerReaction::value(const Point & /*p*/)
{
