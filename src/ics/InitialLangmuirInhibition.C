...
InputParameters
InitialLangmuirInhibition::validParams()
{
...
void
InitialLangmuirInhibition::computeAllLangmuirCoeffs()
{
  for (unsigned int i = 0; i < _coupled.size(); ++i)
  {
...
Real
InitialLangmuirInhibition::computeLangmuirTerm(int i)
{
  Real val = 0.0;
...
Real
InitialLangmuirInhibition::value(const Point & /*p*/)
{
