...
InputParameters
SimpleGasFlatSurfaceMassTransCoef::validParams()
{
...
SimpleGasFlatSurfaceMassTransCoef::SimpleGasFlatSurfaceMassTransCoef(
...
Real
SimpleGasFlatSurfaceMassTransCoef::computeValue()
{
  // rho [g/cm^3]
