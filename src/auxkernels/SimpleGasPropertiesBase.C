...
InputParameters
SimpleGasPropertiesBase::validParams()
{
  ...
  params.addParam<Real>(
      "ref_diffusivity",
      1.0,
      "Reference diffusivity value (e.g., molecular gas-phase diffusion constant)");
  ...
  params.addParam<Real>(
      ...
      1.4,
      "Factor applied to pore diffusivity to estimate effective diffusion: Range (1,2)");
...
void
SimpleGasPropertiesBase::unsupported_conversion(std::string from, std::string to)
{
...
Real
SimpleGasPropertiesBase::length_conversion(Real value, std::string from, std::string to)
{
  Real new_value = 0;
...
Real
SimpleGasPropertiesBase::time_conversion(Real value, std::string from, std::string to)
{
  Real new_value = 0;
...
Real
SimpleGasPropertiesBase::mass_conversion(Real value, std::string from, std::string to)
{
  Real new_value = 0;
...
Real
SimpleGasPropertiesBase::energy_conversion(Real value, std::string from, std::string to)
{
  Real new_value = 0;
...
Real
SimpleGasPropertiesBase::pressure_conversion(Real value, std::string from, std::string to)
{
  Real new_value = 0;
...
Real
SimpleGasPropertiesBase::volume_conversion(Real value, std::string from, std::string to)
{
  Real new_value = 0;
...
Real
SimpleGasPropertiesBase::volume_fraction_conversion(Real value, std::string from, std::string to)
{
  Real new_value = 0;
...
Real
SimpleGasPropertiesBase::computeValue()
{
