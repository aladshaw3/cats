...
InputParameters SimpleGasCylinderWallHeatTransCoef::validParams()
{
...
SimpleGasCylinderWallHeatTransCoef::SimpleGasCylinderWallHeatTransCoef(const InputParameters & parameters) :
...
Real SimpleGasCylinderWallHeatTransCoef::computeValue()
{
