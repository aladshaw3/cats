...
InputParameters
TemporalStepFunction::validParams()
{
  ...
  params.addRequiredParam<std::vector<Real>>("aux_times",
                                             "Time values at which to update aux value");
...
Real
TemporalStepFunction::newValue(Real time)
{
...
Real
TemporalStepFunction::computeValue()
{
