...
[Mesh]
  ...
  [../]
  #MUST create a subdomain of the same dimensionality as the main domain
  [./bound]
...
[Kernels]
  ...
  #  variable = conc
  #  coefficient = 1.0
  #  block = '1'         #block id 1 corresponds to the boundaries from our MeshSideSet
  #[../]

  ##NOTE: STUFF BELOW WORKS ONLY IF THE BLOCKS ARE ALL THE SAME DIMENSION ##
  [./coupled_dot]
...
[BCs]
  ...
  [./conc_FluxOut]
    type = DGConcentrationFluxBC
    variable = conc
    #boundary = 'outlet top bottom object'   #NOTE: Don't need at walls
    boundary = 'outlet'
    u_input = 0.0
    ux = vel_x
    uy = vel_y
