...
#
#   What-if Scenario: Same case as 'CuSSZ13_NH3_storage.i'
#   ======================================================
#
#   Demonstration of how diffusion limitations impact adsorption
#   of ammonia into the washcoat. In this case, we use an unrealistically
#   low diffusivity just to demonstrate ammonia loading distribution into
#   the corners of the washcoat.
...
[AuxKernels]
    ...
    # now use Knudsen relationship which should result in slower diffusion
    [./Dw_calc]
        ...
        # artifically reduced diffusion coefficient for the
        #   what-if scenario
        ref_diffusivity = 0.0561
        diff_length_unit = "cm"
        diff_time_unit = "s"
        ref_diff_temp = 473
