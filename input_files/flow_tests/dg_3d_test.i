...
#   in the 3D perforated cylinder mesh. NOTE: Because DG methods
#   require more DOFs than non-DG methods, this runs MUCH slower
#   and requires more memory than the standard MOOSE module with
#   SUPG methods.
#
