...
#O2 concentration (used as a variable for moving through time)
  [./O2]
    order = FIRST
    family = MONOMIAL
    initial_condition = 7240 #ppm
  [../]
 
  [./CO]
    order = FIRST
    family = MONOMIAL
    initial_condition = 5306 #ppm
  [../]
  ...
  [./HC_heptane]
    order = FIRST
    family = MONOMIAL
    initial_condition = 385.7143 #ppm
  [../]
 
  [./HC_toluene]
     order = FIRST
     family = MONOMIAL
     initial_condition = 42.85714 #ppm
  [../]
