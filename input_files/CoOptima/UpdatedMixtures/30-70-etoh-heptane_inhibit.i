  ...
  [./R_HC]
    ...
    family = MONOMIAL
     [./InitialCondition]
         type = InitialLangmuirInhibition
         temperature = temp
         coupled_list = 'HCw_heptane HCw_etoh'
...
# -------------------------------------------------------------
    ...
    [./O2w_rxns]
        ...
        variable = O2w
        coupled_list = 'r1 r2 r15 r3_heptane r3_etoh'
        weights = '-0.5 -0.5 -0.25 -11 -3'
        scale = 1
    [../]
    ...
    [./H2Ow_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = H2Ow
        coupled_list = 'r2 r8 r11 r6 r7 r14 r15 r3_heptane r10_heptane r12_heptane r3_etoh r10_etoh r12_etoh'
        weights = '1 -1.5 -1 1 1 1 1.5 8 8 -7 3 3 -1'
        scale = 1
    [../]
    ...
    [./NOxw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = NOxw
        coupled_list = 'r4 r5 r8 r6 r7 r14 r15 r10_heptane r10_etoh'
        weights = '-1 -2 -1 -1 -1 -2 -1 -22 -6'
        scale = 1
    [../]
    ...
    [./COw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = COw
        coupled_list = 'r1 r4 r5 r8 r11 r12_heptane r12_etoh'
        weights = '-1 -1 -1 -2.5 -1 7 2'
        scale = 1
    [../]
    ...
    [./CO2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = CO2w
        coupled_list = 'r1 r4 r5 r8 r11 r3_heptane r10_heptane r3_etoh r10_etoh'
        weights = '1 1 1 2.5 1 7 7 2 2'
        scale = 1
    [../]
    ...
    [./N2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = N2w
        coupled_list = 'r4 r7 r15 r10_heptane r10_etoh'
        weights = '0.5 0.5 1 11 3'
        scale = 1
    [../]
    ...
    [./H2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = H2w
        coupled_list = 'r2 r11 r6 r7 r14 r12_heptane r12_etoh'
        weights = '-1 1 -2.5 -1 -1 15 4'
        scale = 1
    [../]
...
# ============= THC Sum =============
    ...
    [./THC_sum]
      ...
      variable = THC
      coupled_list = 'HC_heptane HC_etoh'
      weights = '7 2'
...
[Functions]
  [./data_fun]
    ...
    data_file = 30-70-etoh-heptane_temperature.txt
  [../]
[]
