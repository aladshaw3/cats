...
# -------------------------------------------------------------
    ...
    [./O2w_rxns]
        ...
        variable = O2w
        coupled_list = 'r1 r2 r15 r3_heptane r3_diiso'
        weights = '-0.5 -0.5 -0.25 -11 -12'
        scale = non_pore
    [../]
    ...
    [./H2Ow_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = H2Ow
        coupled_list = 'r2 r8 r11 r6 r7 r14 r15 r3_heptane r10_heptane r12_heptane r3_diiso r10_diiso r12_diiso'
        weights = '1 -1.5 -1 1 1 1 1.5 8 8 -7 8 8 -8'
        scale = non_pore
    [../]
    ...
    [./NOxw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = NOxw
        coupled_list = 'r4 r5 r8 r6 r7 r14 r15 r10_heptane r10_diiso'
        weights = '-1 -2 -1 -1 -1 -2 -1 -22 -24'
        scale = non_pore
    [../]
    ...
    [./COw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = COw
        coupled_list = 'r1 r4 r5 r8 r11 r12_heptane r12_diiso'
    ...
    [./CO2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = CO2w
        coupled_list = 'r1 r4 r5 r8 r11 r3_heptane r10_heptane r3_diiso r10_diiso'
    ...
    [./N2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = N2w
        coupled_list = 'r4 r7 r15 r10_heptane r10_diiso'
        weights = '0.5 0.5 1 11 12'
        scale = non_pore
    [../]
    ...
    [./H2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = H2w
        coupled_list = 'r2 r11 r6 r7 r14 r12_heptane r12_diiso'
        weights = '-1 1 -2.5 -1 -1 15 16'
        scale = non_pore
    [../]
...
# ============= THC Sum =============
    ...
    [./THC_sum]
      ...
      variable = THC
      coupled_list = 'HC_heptane HC_diiso'
      weights = '7 8'
...
[Functions]
  [./data_fun]
    ...
    data_file = 30-70-diiso-heptane_temperature.txt
  [../]
[]
