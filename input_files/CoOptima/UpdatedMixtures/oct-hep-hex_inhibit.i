...
# -------------------------------------------------------------
    ...
    [./O2w_rxns]
        ...
        variable = O2w
        coupled_list = 'r1 r2 r15 r3_isooctane r3_heptane r3_hexene'
        weights = '-0.5 -0.5 -0.25 -12.5 -11 -9'
        scale = non_pore
    [../]
    ...
    [./H2Ow_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = H2Ow
        coupled_list = 'r2 r8 r11 r6 r7 r14 r15 r3_isooctane r10_isooctane r12_isooctane r3_heptane r10_heptane r12_heptane r3_hexene r10_hexene r12_hexene'
        weights = '1 -1.5 -1 1 1 1 1.5 9 9 -8 8 8 -7 6 6 -6'
        scale = non_pore
    [../]
    ...
    [./NOxw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = NOxw
        coupled_list = 'r4 r5 r8 r6 r7 r14 r15 r10_isooctane r10_heptane r10_hexene'
        weights = '-1 -2 -1 -1 -1 -2 -1 -25 -22 -18'
        scale = non_pore
    [../]
    ...
    [./COw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = COw
        coupled_list = 'r1 r4 r5 r8 r11 r12_isooctane r12_heptane r12_hexene'
        weights = '-1 -1 -1 -2.5 -1 8 7 6'
        scale = non_pore
    [../]
    ...
    [./CO2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = CO2w
        coupled_list = 'r1 r4 r5 r8 r11 r3_isooctane r10_isooctane r3_heptane r10_heptane r3_hexene r10_hexene'
        weights = '1 1 1 2.5 1 8 8 7 7 6 6'
        scale = non_pore
    [../]
    ...
    [./N2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = N2w
        coupled_list = 'r4 r7 r15 r10_isooctane r10_heptane r10_hexene'
        weights = '0.5 0.5 1 12.5 11 9'
        scale = non_pore
    [../]
    ...
    [./H2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = H2w
        coupled_list = 'r2 r11 r6 r7 r14 r12_isooctane r12_heptane r12_hexene'
        weights = '-1 1 -2.5 -1 -1 17 15 12'
        scale = non_pore
    [../]
...
# ============= THC Sum =============
    ...
    [./THC_sum]
      ...
      variable = THC
      coupled_list = 'HC_isooctane HC_heptane HC_hexene'
      weights = '8 7 6'
...
[Functions]
  [./data_fun]
    ...
    data_file = oct-hep-hex_temperature.txt
  [../]
[]
