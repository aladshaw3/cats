  ...
  [./R_HC]
    ...
    family = MONOMIAL
     [./InitialCondition]
         type = InitialLangmuirInhibition
         temperature = temp
         coupled_list = 'HCw_isooctane HCw_toluene HCw_iBuoh'
...
# -------------------------------------------------------------
    ...
    [./O2w_rxns]
        ...
        variable = O2w
        coupled_list = 'r1 r2 r15 r3_isooctane r3_toluene r3_iBuoh r3_heptane r3_hexene'
        weights = '-0.5 -0.5 -0.25 -12.5 -9 -6 -11 -9'
        scale = non_pore
    [../]
    ...
    [./NOxw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = NOxw
        coupled_list = 'r4 r5 r8 r6 r7 r14 r15 r10_isooctane r10_toluene r10_iBuoh r10_heptane r10_hexene'
        weights = '-1 -2 -1 -1 -1 -2 -1 -25 -18 -12 -22 -18'
        scale = non_pore
    [../]
    ...
    [./COw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = COw
        coupled_list = 'r1 r4 r5 r8 r11 r12_isooctane r12_toluene r12_iBuoh r12_heptane r12_hexene'
        weights = '-1 -1 -1 -2.5 -1 8 7 4 7 6'
        scale = non_pore
    [../]
    ...
    [./N2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = N2w
        coupled_list = 'r4 r7 r15 r10_isooctane r10_toluene r10_iBuoh r10_heptane r10_hexene'
        weights = '0.5 0.5 1 12.5 9 6 11 9'
        scale = non_pore
    [../]
    ...
    [./H2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = H2w
        coupled_list = 'r2 r11 r6 r7 r14 r12_isooctane r12_toluene r12_iBuoh r12_heptane r12_hexene'
        weights = '-1 1 -2.5 -1 -1 17 11 8 15 12'
        scale = non_pore
    [../]
    ...
    [./HCw_iBuoh_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = HCw_iBuoh
        coupled_list = 'r3_iBuoh r10_iBuoh r12_iBuoh'
        weights = '-1 -1 -1'
        scale = non_pore
    [../]
...
# CxHyOz + (2x + (y/2) - z) NO --> x CO2 + (y/2) H2O + (x + (y/4) - (z/2)) N2
    ...
    [./r10_iBuoh_rx]
      ...
      temperature = temp
      scale = 1.0
      reactants = 'HCw_iBuoh NOxw'
      reactant_stoich = '1 1'
      products = ''
      product_stoich = ''
    [../]

## ======= HC_iBuoh Steam Reforming Rxn ======
# CxHyOz + (x - z) H2O --> x CO + (x + (y/2) - z) H2
    [./r12_iBuoh_val]
        type = Reaction
        variable = r12_iBuoh
...
# CxHyOz + (2x + (y/2) - z) NO --> x CO2 + (y/2) H2O + (x + (y/4) - (z/2)) N2
    ...
    [./r10_heptane_rx]
      ...
      forward_activation_energy = 344704.19832103234
      forward_pre_exponential = 1.189916847226846e+38
...
# ============= HC Term =============
    ...
    [./R_HC_lang]
      ...
      variable = R_HC
      temperature = temp
      coupled_list = 'HCw_heptane HCw_isooctane'
      pre_exponentials = '2.5E5 4.5E6'
      activation_energies = '-11500 -25000'
    [../]
...
# ============= THC Sum =============
    ...
    [./THC_sum]
      ...
      variable = THC
      coupled_list = 'HC_isooctane HC_toluene HC_iBuoh HC_heptane HC_hexene'
      weights = '8 7 4 7 6'
...
[Functions]
  [./data_fun]
    ...
    data_file = BOB-iBuoh10_temperature.txt
  [../]
[]
