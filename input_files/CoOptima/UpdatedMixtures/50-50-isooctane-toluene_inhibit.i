  ...
  [./R_HC]
    ...
    family = MONOMIAL
     [./InitialCondition]
         type = InitialLangmuirInhibition
         temperature = temp
         coupled_list = 'HCw_toluene HCw_isooctane'
...
# -------------------------------------------------------------
    ...
    #
    # n-toluene ==> x = 7, y = 8, z = 0
    # isooctane ==> x = 8, y = 18, z = 0
    [./O2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = O2w
        coupled_list = 'r1 r2 r15 r3_toluene r3_isooctane'
        weights = '-0.5 -0.5 -0.25 -9 -12.5'
        scale = non_pore
    [../]
    ...
    [./H2Ow_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = H2Ow
        coupled_list = 'r2 r8 r11 r6 r7 r14 r15 r3_toluene r10_toluene r12_toluene r3_isooctane r10_isooctane r12_isooctane'
        weights = '1 -1.5 -1 1 1 1 1.5 4 4 -7 9 9 -8'
        scale = non_pore
    [../]
    ...
    [./NOxw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = NOxw
        coupled_list = 'r4 r5 r8 r6 r7 r14 r15 r10_toluene r10_isooctane'
        weights = '-1 -2 -1 -1 -1 -2 -1 -18 -25'
        scale = non_pore
    [../]
    ...
    [./COw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = COw
        coupled_list = 'r1 r4 r5 r8 r11 r12_toluene r12_isooctane'
    ...
    [./CO2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = CO2w
        coupled_list = 'r1 r4 r5 r8 r11 r3_toluene r10_toluene r3_isooctane r10_isooctane'
    ...
    [./N2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = N2w
        coupled_list = 'r4 r7 r15 r10_toluene r10_isooctane'
        weights = '0.5 0.5 1 9 12.5'
        scale = non_pore
    [../]
    ...
    [./H2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = H2w
        coupled_list = 'r2 r11 r6 r7 r14 r12_toluene r12_isooctane'
        weights = '-1 1 -2.5 -1 -1 11 17'
        scale = non_pore
    [../]
...
# ============= HC Term =============
    ...
    [./R_HC_lang]
      ...
      temperature = temp
      coupled_list = 'HCw_toluene HCw_isooctane'
      pre_exponentials = '0 2.2E5'
      activation_energies = '0 -25000'
    [../]
...
# ============= THC Sum =============
    ...
    [./THC_sum]
      ...
      variable = THC
      coupled_list = 'HC_toluene HC_isooctane'
      weights = '7 8'
...
[Functions]
  [./data_fun]
    ...
    data_file = 50-50-isooctane-toluene_temperature.txt
  [../]
[]
