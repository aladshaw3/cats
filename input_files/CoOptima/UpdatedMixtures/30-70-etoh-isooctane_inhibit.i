  ...
  [./R_HC]
    ...
    family = MONOMIAL
     [./InitialCondition]
         type = InitialLangmuirInhibition
         temperature = temp
         coupled_list = 'HCw_isooctane HCw_etoh'
...
# -------------------------------------------------------------
    ...
    [./O2w_rxns]
        ...
        variable = O2w
        coupled_list = 'r1 r2 r15 r3_isooctane r3_etoh'
        weights = '-0.5 -0.5 -0.25 -12.5 -3'
        scale = 1
    [../]
    ...
    [./H2Ow_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = H2Ow
        coupled_list = 'r2 r8 r11 r6 r7 r14 r15 r3_isooctane r10_isooctane r12_isooctane r3_etoh r10_etoh r12_etoh'
        weights = '1 -1.5 -1 1 1 1 1.5 9 9 -8 3 3 -1'
        scale = 1
    [../]
    ...
    [./NOxw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = NOxw
        coupled_list = 'r4 r5 r8 r6 r7 r14 r15 r10_isooctane r10_etoh'
        weights = '-1 -2 -1 -1 -1 -2 -1 -25 -6'
        scale = 1
    [../]
    ...
    [./COw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = COw
        coupled_list = 'r1 r4 r5 r8 r11 r12_isooctane r12_etoh'
        weights = '-1 -1 -1 -2.5 -1 8 2'
        scale = 1
    [../]
    ...
    [./CO2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = CO2w
        coupled_list = 'r1 r4 r5 r8 r11 r3_isooctane r10_isooctane r3_etoh r10_etoh'
        weights = '1 1 1 2.5 1 8 8 2 2'
        scale = 1
    [../]
    ...
    [./N2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = N2w
        coupled_list = 'r4 r7 r15 r10_isooctane r10_etoh'
        weights = '0.5 0.5 1 12.5 3'
        scale = 1
    [../]
    ...
    [./H2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = H2w
        coupled_list = 'r2 r11 r6 r7 r14 r12_isooctane r12_etoh'
        weights = '-1 1 -2.5 -1 -1 17 4'
        scale = 1
    [../]
    ...
    [./HCw_etoh_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = HCw_etoh
        coupled_list = 'r3_etoh r10_etoh r12_etoh'
        weights = '-1 -1 -1'
        scale = 1
    [../]
...
# CxHyOz + (2x + (y/2) - z) NO --> x CO2 + (y/2) H2O + (x + (y/4) - (z/2)) N2
    ...
    [./r10_etoh_rx]
      ...
      temperature = temp
      scale = 1.0
      reactants = 'HCw_etoh NOxw'
      reactant_stoich = '1 1'
      products = ''
      product_stoich = ''
    [../]

## ======= HC_etoh Steam Reforming Rxn ======
# CxHyOz + x H2O --> x CO + (x + (y/2)) H2 + (z/2) O2
    [./r12_etoh_val]
        type = Reaction
        variable = r12_etoh
...
# ============= THC Sum =============
    ...
    [./THC_sum]
      ...
      variable = THC
      coupled_list = 'HC_isooctane HC_etoh'
      weights = '8 2'
...
[Functions]
  [./data_fun]
    ...
    data_file = 30-70-etoh-isooctane_temperature.txt
  [../]
[]
