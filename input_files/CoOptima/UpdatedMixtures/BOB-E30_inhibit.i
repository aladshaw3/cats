...
# -------------------------------------------------------------
    ...
    [./O2w_rxns]
        ...
        variable = O2w
        coupled_list = 'r1 r2 r15 r3_isooctane r3_toluene r3_ethanol r3_heptane r3_hexene'
        weights = '-0.5 -0.5 -0.25 -12.5 -9 -3 -11 -9'
        scale = 1
    [../]
    ...
    [./H2Ow_rxns]
        ...
        coupled_list = 'r2 r8 r11 r6 r7 r14 r15
                        ...
                        r3_ethanol r10_ethanol r12_ethanol
    ...
    [./NOxw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = NOxw
        coupled_list = 'r4 r5 r8 r6 r7 r14 r15 r10_isooctane r10_toluene r10_ethanol r10_heptane r10_hexene'
        weights = '-1 -2 -1 -1 -1 -2 -1 -25 -18 -6 -22 -18'
        scale = 1
    [../]
    ...
    [./COw_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = COw
        coupled_list = 'r1 r4 r5 r8 r11 r12_isooctane r12_toluene r12_ethanol r12_heptane r12_hexene'
        weights = '-1 -1 -1 -2.5 -1 8 7 2 7 6'
        scale = 1
    [../]
    ...
    [./N2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = N2w
        coupled_list = 'r4 r7 r15 r10_isooctane r10_toluene r10_ethanol r10_heptane r10_hexene'
        weights = '0.5 0.5 1 12.5 9 3 11 9'
        scale = 1
    [../]
    ...
    [./H2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = H2w
        coupled_list = 'r2 r11 r6 r7 r14 r12_isooctane r12_toluene r12_ethanol r12_heptane r12_hexene'
        weights = '-1 1 -2.5 -1 -1 17 11 4 15 12'
        scale = 1
    [../]
...
# ============= THC Sum =============
    ...
    [./THC_sum]
      ...
      variable = THC
      coupled_list = 'HC_isooctane HC_toluene HC_ethanol HC_heptane HC_hexene'
      weights = '8 7 2 7 6'
...
[Functions]
  [./data_fun]
    ...
    data_file = BOB-E30_temperature.txt
  [../]
[]
