...
# -------------------------------------------------------------
    ...
    [./H2Ow_rxns]
        ...
        weights = '1 -1.5 -1 1 1 1 1.5 2 2 -1'
        scale = non_pore
    [../]
...
# CxHyOz + (2x + (y/2) - z) NO --> x CO2 + (y/2) H2O + (x + (y/4) - (z/2)) N2
    ...
    [./r10_rx]
      ...
      forward_pre_exponential = 1.8195374337544053e+12
...
# CxHyOz + x H2O --> x CO + (x + (y/2)) H2 + (z/2) O2
    ...
    [./r12_rx]
      ...
      forward_activation_energy = 136610.55181420766
      forward_pre_exponential = 1.8429782328496848e+10
...
[Functions]
  [./data_fun]
    ...
    data_file = methane_temperature.txt
  [../]
[]
