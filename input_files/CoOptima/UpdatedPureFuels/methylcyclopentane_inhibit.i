...
# -------------------------------------------------------------
    ...
    #
    # methylcyclopentane ==> x = 6, y = 12, z = 0
    [./O2w_rxns]
...
[Functions]
  [./data_fun]
    ...
    data_file = methylcyclopentane_temperature.txt
  [../]
[]
...
[Postprocessors]
    ...
    [./O2_bypass]
        ...
        #NOTE: Return value of variable at given element in mesh
        #     To do this, you must know the elementid number that
        #     corresponds to the position of interest.
