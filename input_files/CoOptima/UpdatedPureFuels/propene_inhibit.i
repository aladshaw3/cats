...
# -------------------------------------------------------------
    ...
    [./H2Ow_rxns]
        ...
        weights = '1 -1.5 -1 1 1 1 1.5 3 3 -3'
        scale = non_pore
    [../]
...
# CxHyOz + (x + (y/4) - (z/2)) O2 --> x CO2 + (y/2) H2O
    ...
    [./r3_rx]
      ...
      forward_activation_energy = 205504.19832103234
      forward_pre_exponential = 9.189916847226846e+25
...
# CxHyOz + (2x + (y/2) - z) NO --> x CO2 + (y/2) H2O + (x + (y/4) - (z/2)) N2
    ...
    [./r10_rx]
      ...
      forward_pre_exponential = 4.489916847226846e+36
...
# CxHyOz + x H2O --> x CO + (x + (y/2)) H2 + (z/2) O2
    ...
    [./r12_rx]
      ...
      forward_pre_exponential = 1.5429782328496848e+20
...
# ============= HC Term =============
   ...
   [./R_HC_lang]
     ...
     temperature = temp
     coupled_list = 'HCw'
     pre_exponentials = '1.25E6'
     activation_energies = '-19000'
   [../]
...
[Functions]
  [./data_fun]
    ...
    data_file = propene_temperature.txt
  [../]
[]
