  ...
  [./R_HC]
    ...
    family = MONOMIAL
     [./InitialCondition]
         ...
         temperature = temp
         coupled_list = 'HCw'
         pre_exponentials = '1.02E-2'
         activation_energies = '-93336'
     [../]
  [../]
...
# -------------------------------------------------------------
    ...
    #
    # 2-methylpentane ==> x = 6, y = 14, z = 0
    [./O2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = O2w
        coupled_list = 'r1 r2 r15 r3'
        weights = '-0.5 -0.5 -0.25 -9.5'
        scale = non_pore
    [../]
    ...
    [./H2Ow_rxns]
        ...
        weights = '1 -1.5 -1 1 1 1 1.5 7 7 -6'
        scale = non_pore
    [../]
...
[Functions]
  [./data_fun]
    ...
    data_file = 2-methylpentane_temperature.txt
  [../]
