...
# -------------------------------------------------------------
    ...
    #
    # iso-butanol ==> x = 4, y = 10, z = 1
    [./O2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = O2w
        coupled_list = 'r1 r2 r15 r3'
        weights = '-0.5 -0.5 -0.25 -6'
        scale = non_pore
    [../]
    ...
    [./H2Ow_rxns]
        ...
        weights = '1 -1.5 -1 1 1 1 1.5 5 5 -3'
        scale = non_pore
    [../]
...
[Functions]
  [./data_fun]
    ...
    data_file = iso-butanol_temperature.txt
  [../]
[]
