  ...
  [./R_HC]
    ...
    family = MONOMIAL
     [./InitialCondition]
         ...
         temperature = temp
         coupled_list = 'HCw'
         pre_exponentials = '1.21E-1'
         activation_energies = '-83981'
     [../]
  [../]
...
# -------------------------------------------------------------
    ...
    #
    # methylcyclohexane ==> x = 7, y = 14, z = 0
    [./O2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = O2w
        coupled_list = 'r1 r2 r15 r3'
        weights = '-0.5 -0.5 -0.25 -10.5'
        scale = non_pore
    [../]
    ...
    [./H2Ow_rxns]
        ...
        weights = '1 -1.5 -1 1 1 1 1.5 7 7 -7'
        scale = non_pore
    [../]
...
# CxHyOz + (x + (y/4) - (z/2)) O2 --> x CO2 + (y/2) H2O
    ...
    [./r3_rx]
      ...
      forward_activation_energy = 153778.07841100253
      forward_pre_exponential = 8.2278118615710487e+21
...
# CxHyOz + (2x + (y/2) - z) NO --> x CO2 + (y/2) H2O + (x + (y/4) - (z/2)) N2
    ...
    [./r10_rx]
      ...
      forward_activation_energy = 360722.9558304948
      forward_pre_exponential = 2.3543644057580242e+39
...
# CxHyOz + x H2O --> x CO + (x + (y/2)) H2 + (z/2) O2
    ...
    [./r12_rx]
      ...
      forward_activation_energy = 199734.3143765249
      forward_pre_exponential = 6.8117e+22
...
# ============= HC Term =============
    ...
    [./R_HC_lang]
      ...
      pre_exponentials = '5.0E4'
      activation_energies = '-16500'
    [../]
...
[Functions]
  [./data_fun]
    ...
    data_file = methylcyclohexane_temperature.txt
  [../]
[]
