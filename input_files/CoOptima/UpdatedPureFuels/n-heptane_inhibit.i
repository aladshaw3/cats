...
# -------------------------------------------------------------
    ...
    [./H2Ow_rxns]
        ...
        weights = '1 -1.5 -1 1 1 1 1.5 8 8 -7'
        scale = non_pore
    [../]
...
# ============= HC Term =============
    ...
    [./R_HC_lang]
      ...
      pre_exponentials = '2.5E5'
      activation_energies = '-11500'
    [../]
...
[Functions]
  [./data_fun]
    ...
    data_file = n-heptane_temperature.txt
  [../]
[]
