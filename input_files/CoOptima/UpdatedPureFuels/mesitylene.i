...
# -------------------------------------------------------------
    ...
    #
    # mesitylene ==> x = 9, y = 12, z = 0
    [./O2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = O2w
        coupled_list = 'r1 r2 r15 r3'
        weights = '-0.5 -0.5 -0.25 -12'
        scale = non_pore
    [../]
    ...
    [./H2Ow_rxns]
        ...
        weights = '1 -1.5 -1 1 1 1 1.5 6 6 -9'
        scale = non_pore
    [../]
...
[Functions]
  [./data_fun]
    ...
    data_file = mesitylene_temperature.txt
  [../]
[]
