...
# -------------------------------------------------------------
    ...
    #
    # 2-butanone ==> x = 4, y = 8, z = 1
    [./O2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = O2w
        coupled_list = 'r1 r2 r15 r3'
        weights = '-0.5 -0.5 -0.25 -5.5'
        scale = non_pore
    [../]
    ...
    [./H2Ow_rxns]
        ...
        weights = '1 -1.5 -1 1 1 1 1.5 4 4 -3'
        scale = non_pore
    [../]
...
# CxHyOz + (x + (y/4) - (z/2)) O2 --> x CO2 + (y/2) H2O
    ...
    [./r3_rx]
      ...
      forward_activation_energy = 130209.7737
      forward_pre_exponential = 8.289972387087877e+19
...
# CxHyOz + (2x + (y/2) - z) NO --> x CO2 + (y/2) H2O + (x + (y/4) - (z/2)) N2
    ...
    [./r10_rx]
      ...
      forward_activation_energy = 230582.46
      forward_pre_exponential = 3.273822512925783e+28
...
# CxHyOz + (x - z) H2O --> x CO + (x + (y/2) - z) H2
    ...
    [./r12_rx]
      ...
      forward_activation_energy = 108372.82
      forward_pre_exponential = 1061117785054690.6
...
[Functions]
  [./data_fun]
    ...
    data_file = 2-butanone_temperature.txt
  [../]
