...
# -------------------------------------------------------------
    ...
    #
    # ethylacetate ==> x = 4, y = 8, z = 2
    [./O2w_rxns]
        type = ScaledWeightedCoupledSumFunction
        variable = O2w
        coupled_list = 'r1 r2 r15 r3'
        weights = '-0.5 -0.5 -0.25 -5'
        scale = non_pore
    [../]
...
# CxHyOz + (x + (y/4) - (z/2)) O2 --> x CO2 + (y/2) H2O
    ...
    [./r3_rx]
      ...
      forward_pre_exponential = 3.689916847226846e+33
...
# CxHyOz + x H2O --> x CO + (x + (y/2)) H2 + (z/2) O2
    ...
    [./r12_rx]
      ...
      forward_activation_energy = 136610.55181420766
      forward_pre_exponential = 1.8429782328496848e+18
...
[Functions]
  [./data_fun]
    ...
    data_file = ethylacetate_temperature.txt
  [../]
[]
