...
[AuxVariables]
  ...
  [./w1]
      order = FIRST
      family = MONOMIAL
      initial_condition = 0.0483893
  [../]

  [./w2]
      order = FIRST
      family = MONOMIAL
      initial_condition = 0.0266486
  [../]

  [./w3]
      order = FIRST
      family = MONOMIAL
      initial_condition = 0.0116836
  [../]
...
[AuxKernels]
    ...
    [./temp_increase]
        ...
        variable = temp
        start_time = 269.258333
        end_time = 329.091667
        end_value = 810.6748493
...
[BCs]
    ...
    [./NH3_FluxIn]
      ...
      uy = vel_y
      uz = vel_z
      input_vals = '2.29245E-05    1.82207E-05    1.35655E-05    8.97999E-06    4.55186E-06    2.28139E-06    1.14301E-06    5.73924E-07    2.92378E-07    9.18673E-10'
      input_times = '2.09166667    19.925    28.7583333    40.5916667    56.0916667    75.0916667    106.091667    144.091667    198.925    269.258333'
