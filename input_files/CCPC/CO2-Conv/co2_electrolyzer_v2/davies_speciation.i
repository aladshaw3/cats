...
#
# BEST SOLUTION: Apply the C_ref scale to the value of the reaction kernel
#           itself through the 'scale'. This 'scale' MUST be a constant and
#           not a variable, so if C_ref is total concentration, then this
#           does not work and instead you would apply 'scale = C_ref' under
#           the 'ScaledWeightedCoupledSumFunction'.
...
[Variables]
  ...
  # HCO3 concentration (3 M added as KHCO3)
  [./C_HCO3]
      order = FIRST
      family = MONOMIAL
      initial_condition = 3e-3 # mol/cm^3
  [../]
...
[AuxVariables]
  # K concentration (3 M added as KHCO3)
  [./C_K]
      order = FIRST
      family = MONOMIAL
      initial_condition = 3e-3 # mol/cm^3
  ...
  [./ion_str]
      ...
      [./InitialCondition]
          ...
          ion_conc = 'C_H C_OH C_HCO3 C_CO3 C_HCOO C_K'
