# This appears to work, so long as I have some background reference ion
# Otherwise, the conductivity becomes non-physical for this case.

# TODO: Convert phi calculation to DG methods for stability
