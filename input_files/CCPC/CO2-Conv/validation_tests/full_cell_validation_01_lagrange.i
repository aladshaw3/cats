...
#
#    This tests the validation problem using all LAGRANGE shape functions.
#       Computationally more efficient, but may result in oscillations
#       near or in membrane where a piece-wise continuous solution is
#       a little dubious. 
