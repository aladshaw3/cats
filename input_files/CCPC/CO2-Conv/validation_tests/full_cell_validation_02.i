...
[Variables]
  ...
  [./V_II]
      order = FIRST
      family = MONOMIAL
      initial_condition = 0.000036 #mol/cm^3
      block = 'neg_electrode'
  [../]
  ...
  [./V_III]
      order = FIRST
      family = MONOMIAL
      initial_condition = 0.001404 #mol/cm^3
      block = 'neg_electrode'
  [../]
...
[Executioner]
  ...
  # Case: time: 0 - 45.2 min (charging at 10 A)
  #       time: 45.2 - 47.2 min (zero current pull)
  #       time: 47.2 - 88 min (discharging at 10 A)
