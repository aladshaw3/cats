...
# -------------------------
#   This has the most realistic set of parameters and should serve
#     as a primary test of the methods.
...
[Variables]
  ...
  [./r_O2]
      ...
      [./InitialCondition]
          ...
          reaction_rate_const = 2.258E-9    # mol/mm^2/s  (based on literature)
...
[Kernels]
  ...
  [./r_O2_rxn]  # H2O <----> 0.5 O2 + 2 H+ + 2 e-
      ...
      oxidized_state_vars = 'a_H a_O2'
      oxidized_state_stoich = '2 1'  # use stoich for H+ (define a_O2 == 1)
