...
# Test intraparticle diffusion constants
    [./Dk]
        order = FIRST
        family = MONOMIAL
        initial_condition = 3.25E-6    #m^2/s
    [../]

    [./Dp]
        order = FIRST
        family = MONOMIAL
        initial_condition = 7.7E-5    #m^2/s
    [../]
...
#        variable = O2p
#        coupled = qc
#        time_coeff = -8.6346E7       #As
#    [../]
# NOTE: May want to create custom reaction kernels for microscale
#    [./O2p_rx]  #   qc + O2p --> CO2p
#        type = ArrheniusReaction
#        variable = O2p
#        this_variable = O2p
...
[Outputs]
    ...
    exodus = true
    csv = true
    time_step_interval = 10   #Number of time steps to wait before writing output
[] #END Outputs
