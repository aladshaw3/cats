...
[Kernels]
 ...
 forward_rate = 438892.2
    ...
    [./q2_rx]  #   NH3 + S2 <-- --> q2
      ...
      variable = q2
      this_variable = q2
 forward_rate = 213972.2146
      reverse_rate = 0.6666667
      scale = 1.0
      reactants = 'NH3 S2'
      reactant_stoich = '1 1'
      products = 'q2'
    ...
    [./q3_rx]  #   NH3 + S3 <-- --> q3
      ...
      variable = q3
      this_variable = q3
 forward_rate = 97923.9396
      reverse_rate = 0.006666667
      scale = 1.0
      reactants = 'NH3 S3'
      reactant_stoich = '1 1'
      products = 'q3'
...
[BCs]
    ...
    [./NH3_FluxIn]
      ...
      uy = vel_y
      uz = vel_z
      input_vals = '2.31023E-05    1.83165E-05    1.36055E-05    9.01355E-06    4.54339E-06    2.26688E-06    1.13239E-06    5.79503E-07    2.9239E-07    3.7546E-09'
      input_times = '2.09166667    19.5916667    28.425    39.0916667    52.425    76.5916667    108.258333    150.091667    198.591667    284.091667'
