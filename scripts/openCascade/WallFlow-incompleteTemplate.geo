...
//Place points and lines for plugs 
// NOTE: This is just temporary (only valid fr n=2)
x=0; y=0; z=0;

Point(21) = {x+plug, y+dwall+dcoat, z, 1.0};
Point(22) = {x+plug, y+dwall+dcoat+dc, z, 1.0};

y=y+dwall+dcoat+dc+dcoat;
Point(23) = {x+L-plug, y+dwall+dcoat, z, 1.0};
Point(24) = {x+L-plug, y+dwall+dcoat+dc, z, 1.0};
