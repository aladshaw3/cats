...
sim.ignore_weight_factor("NH3","Unaged",Tstr,time_window=(137,150))
sim.ignore_weight_factor("NO","Unaged",Tstr,time_window=(137,150))
sim.ignore_weight_factor("NO2","Unaged",Tstr,time_window=(137,150))
sim.ignore_weight_factor("N2O","Unaged",Tstr,time_window=(137,150))

sim.ignore_weight_factor("NH3","2hr",Tstr,time_window=(126,150))
sim.ignore_weight_factor("NO","2hr",Tstr,time_window=(126,150))
sim.ignore_weight_factor("NO2","2hr",Tstr,time_window=(126,150))
sim.ignore_weight_factor("N2O","2hr",Tstr,time_window=(126,150))

sim.ignore_weight_factor("NH3","4hr",Tstr,time_window=(120,150))
sim.ignore_weight_factor("NO","4hr",Tstr,time_window=(120,150))
sim.ignore_weight_factor("NO2","4hr",Tstr,time_window=(120,150))
sim.ignore_weight_factor("N2O","4hr",Tstr,time_window=(120,150))

sim.ignore_weight_factor("NH3","8hr",Tstr,time_window=(116,150))
sim.ignore_weight_factor("NO","8hr",Tstr,time_window=(116,150))
sim.ignore_weight_factor("NO2","8hr",Tstr,time_window=(116,150))
sim.ignore_weight_factor("N2O","8hr",Tstr,time_window=(116,150))

sim.ignore_weight_factor("NH3","16hr",Tstr,time_window=(110,150))
sim.ignore_weight_factor("NO","16hr",Tstr,time_window=(110,150))
sim.ignore_weight_factor("NO2","16hr",Tstr,time_window=(110,150))
sim.ignore_weight_factor("N2O","16hr",Tstr,time_window=(110,150))
