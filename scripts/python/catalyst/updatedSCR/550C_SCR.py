...
data = naively_read_data_file("inputfiles/SCR_all-ages_550C.txt",factor=1)
...
sim.add_temperature_set(["550C"])
sim.add_data_temperature_set(["550C"])     # Data observations can be a sub-set

sim.add_gas_species(["NH3","H2O","O2","NO","NO2","N2O","N2"])
sim.add_data_gas_species(["NH3","NO","NO2","N2O"])    # Data observations can be a sub-set

sim.set_data_values_for("NH3","Unaged","550C",5,data["time"],data["NH3_Unaged"])
sim.set_data_values_for("NO","Unaged","550C",5,data["time"],data["NO_Unaged"])
sim.set_data_values_for("NO2","Unaged","550C",5,data["time"],data["NO2_Unaged"])
sim.set_data_values_for("N2O","Unaged","550C",5,data["time"],data["N2O_Unaged"])

sim.set_data_values_for("NH3","2hr","550C",5,data["time"],data["NH3_2hr"])
sim.set_data_values_for("NO","2hr","550C",5,data["time"],data["NO_2hr"])
sim.set_data_values_for("NO2","2hr","550C",5,data["time"],data["NO2_2hr"])
sim.set_data_values_for("N2O","2hr","550C",5,data["time"],data["N2O_2hr"])

sim.set_data_values_for("NH3","4hr","550C",5,data["time"],data["NH3_4hr"])
sim.set_data_values_for("NO","4hr","550C",5,data["time"],data["NO_4hr"])
sim.set_data_values_for("NO2","4hr","550C",5,data["time"],data["NO2_4hr"])
sim.set_data_values_for("N2O","4hr","550C",5,data["time"],data["N2O_4hr"])

sim.set_data_values_for("NH3","8hr","550C",5,data["time"],data["NH3_8hr"])
sim.set_data_values_for("NO","8hr","550C",5,data["time"],data["NO_8hr"])
sim.set_data_values_for("NO2","8hr","550C",5,data["time"],data["NO2_8hr"])
sim.set_data_values_for("N2O","8hr","550C",5,data["time"],data["N2O_8hr"])

sim.set_data_values_for("NH3","16hr","550C",5,data["time"],data["NH3_16hr"])
sim.set_data_values_for("NO","16hr","550C",5,data["time"],data["NO_16hr"])
sim.set_data_values_for("NO2","16hr","550C",5,data["time"],data["NO2_16hr"])
sim.set_data_values_for("N2O","16hr","550C",5,data["time"],data["N2O_16hr"])
...
sim.set_isothermal_temp("Unaged","550C",550+273.15)
sim.set_isothermal_temp("2hr","550C",550+273.15)
sim.set_isothermal_temp("4hr","550C",550+273.15)
sim.set_isothermal_temp("8hr","550C",550+273.15)
sim.set_isothermal_temp("16hr","550C",550+273.15)
...
# ---------------- Unaged ICs ------------------
sim.set_const_IC("O2","Unaged","550C",0.001480842)
sim.set_const_IC("H2O","Unaged","550C",0.00073807)
sim.set_const_IC("NH3","Unaged","550C",0)
sim.set_const_IC("NO","Unaged","550C",0)
sim.set_const_IC("NO2","Unaged","550C",0)
sim.set_const_IC("N2O","Unaged","550C",0)
sim.set_const_IC("N2","Unaged","550C",0.0184)

sim.set_const_IC("Z1CuOH-NH3","Unaged","550C",0)
sim.set_const_IC("Z2Cu-NH3","Unaged","550C",0)
sim.set_const_IC("Z2Cu-(NH3)2","Unaged","550C",0)
sim.set_const_IC("ZNH4","Unaged","550C",0)
sim.set_const_IC("Z1CuOH-H2O","Unaged","550C",0)
sim.set_const_IC("Z2Cu-H2O","Unaged","550C",0)
sim.set_const_IC("Z1CuOH-NH4NO3","Unaged","550C",0)
sim.set_const_IC("Z2Cu-NH4NO3","Unaged","550C",0)
sim.set_const_IC("ZH-NH4NO3","Unaged","550C",0)

# ---------------- 2hr ICs ------------------
sim.set_const_IC("O2","2hr","550C",0.001480842)
sim.set_const_IC("H2O","2hr","550C",0.00073807)
sim.set_const_IC("NH3","2hr","550C",0)
sim.set_const_IC("NO","2hr","550C",0)
sim.set_const_IC("NO2","2hr","550C",0)
sim.set_const_IC("N2O","2hr","550C",0)
sim.set_const_IC("N2","2hr","550C",0.0184)

sim.set_const_IC("Z1CuOH-NH3","2hr","550C",0)
sim.set_const_IC("Z2Cu-NH3","2hr","550C",0)
sim.set_const_IC("Z2Cu-(NH3)2","2hr","550C",0)
sim.set_const_IC("ZNH4","2hr","550C",0)
sim.set_const_IC("Z1CuOH-H2O","2hr","550C",0)
sim.set_const_IC("Z2Cu-H2O","2hr","550C",0)
sim.set_const_IC("Z1CuOH-NH4NO3","2hr","550C",0)
sim.set_const_IC("Z2Cu-NH4NO3","2hr","550C",0)
sim.set_const_IC("ZH-NH4NO3","2hr","550C",0)

# ---------------- 4hr ICs ------------------
sim.set_const_IC("O2","4hr","550C",0.001480842)
sim.set_const_IC("H2O","4hr","550C",0.00073807)
sim.set_const_IC("NH3","4hr","550C",0)
sim.set_const_IC("NO","4hr","550C",0)
sim.set_const_IC("NO2","4hr","550C",0)
sim.set_const_IC("N2O","4hr","550C",0)
sim.set_const_IC("N2","4hr","550C",0.0184)

sim.set_const_IC("Z1CuOH-NH3","4hr","550C",0)
sim.set_const_IC("Z2Cu-NH3","4hr","550C",0)
sim.set_const_IC("Z2Cu-(NH3)2","4hr","550C",0)
sim.set_const_IC("ZNH4","4hr","550C",0)
sim.set_const_IC("Z1CuOH-H2O","4hr","550C",0)
sim.set_const_IC("Z2Cu-H2O","4hr","550C",0)
sim.set_const_IC("Z1CuOH-NH4NO3","4hr","550C",0)
sim.set_const_IC("Z2Cu-NH4NO3","4hr","550C",0)
sim.set_const_IC("ZH-NH4NO3","4hr","550C",0)

# ---------------- 8hr ICs ------------------
sim.set_const_IC("O2","8hr","550C",0.001480842)
sim.set_const_IC("H2O","8hr","550C",0.00073807)
sim.set_const_IC("NH3","8hr","550C",0)
sim.set_const_IC("NO","8hr","550C",0)
sim.set_const_IC("NO2","8hr","550C",0)
sim.set_const_IC("N2O","8hr","550C",0)
sim.set_const_IC("N2","8hr","550C",0.0184)

sim.set_const_IC("Z1CuOH-NH3","8hr","550C",0)
sim.set_const_IC("Z2Cu-NH3","8hr","550C",0)
sim.set_const_IC("Z2Cu-(NH3)2","8hr","550C",0)
sim.set_const_IC("ZNH4","8hr","550C",0)
sim.set_const_IC("Z1CuOH-H2O","8hr","550C",0)
sim.set_const_IC("Z2Cu-H2O","8hr","550C",0)
sim.set_const_IC("Z1CuOH-NH4NO3","8hr","550C",0)
sim.set_const_IC("Z2Cu-NH4NO3","8hr","550C",0)
sim.set_const_IC("ZH-NH4NO3","8hr","550C",0)

# ---------------- 16hr ICs ------------------
sim.set_const_IC("O2","16hr","550C",0.001480842)
sim.set_const_IC("H2O","16hr","550C",0.00073807)
sim.set_const_IC("NH3","16hr","550C",0)
sim.set_const_IC("NO","16hr","550C",0)
sim.set_const_IC("NO2","16hr","550C",0)
sim.set_const_IC("N2O","16hr","550C",0)
sim.set_const_IC("N2","16hr","550C",0.0184)

sim.set_const_IC("Z1CuOH-NH3","16hr","550C",0)
sim.set_const_IC("Z2Cu-NH3","16hr","550C",0)
sim.set_const_IC("Z2Cu-(NH3)2","16hr","550C",0)
sim.set_const_IC("ZNH4","16hr","550C",0)
sim.set_const_IC("Z1CuOH-H2O","16hr","550C",0)
sim.set_const_IC("Z2Cu-H2O","16hr","550C",0)
sim.set_const_IC("Z1CuOH-NH4NO3","16hr","550C",0)
sim.set_const_IC("Z2Cu-NH4NO3","16hr","550C",0)
sim.set_const_IC("ZH-NH4NO3","16hr","550C",0)


#Read in data tuples to use as BCs
data_tup = naively_read_data_file("inputfiles/protocol_SCR_all-ages_550C.txt",
                                    factor=1,dict_of_tuples=True)

# ---------------- Unaged BCs ------------------
sim.set_time_dependent_BC("O2","Unaged","550C",
                            time_value_pairs=data_tup["O2_Unaged"],
                            initial_value=0.001480842)

sim.set_time_dependent_BC("H2O","Unaged","550C",
                            time_value_pairs=data_tup["H2O_Unaged"],
                            initial_value=0.00073807)

sim.set_time_dependent_BC("NH3","Unaged","550C",
                            time_value_pairs=data_tup["NH3_Unaged"],
                            initial_value=0)

sim.set_time_dependent_BC("NO","Unaged","550C",
                            time_value_pairs=data_tup["NO_Unaged"],
                            initial_value=0)

sim.set_time_dependent_BC("NO2","Unaged","550C",
                            time_value_pairs=data_tup["NO2_Unaged"],
                            initial_value=0)

sim.set_const_BC("N2O","Unaged","550C",0)

sim.set_const_BC("N2","Unaged","550C",0.0184)


# ---------------- 2hr BCs ------------------
sim.set_time_dependent_BC("O2","2hr","550C",
                            time_value_pairs=data_tup["O2_2hr"],
                            initial_value=0.001480842)

sim.set_time_dependent_BC("H2O","2hr","550C",
                            time_value_pairs=data_tup["H2O_2hr"],
                            initial_value=0.00073807)

sim.set_time_dependent_BC("NH3","2hr","550C",
                            time_value_pairs=data_tup["NH3_2hr"],
                            initial_value=0)

sim.set_time_dependent_BC("NO","2hr","550C",
                            time_value_pairs=data_tup["NO_2hr"],
                            initial_value=0)

sim.set_time_dependent_BC("NO2","2hr","550C",
                            time_value_pairs=data_tup["NO2_2hr"],
                            initial_value=0)

sim.set_const_BC("N2O","2hr","550C",0)

sim.set_const_BC("N2","2hr","550C",0.0184)


# ---------------- 4hr BCs ------------------
sim.set_time_dependent_BC("O2","4hr","550C",
                            time_value_pairs=data_tup["O2_4hr"],
                            initial_value=0.001480842)

sim.set_time_dependent_BC("H2O","4hr","550C",
                            time_value_pairs=data_tup["H2O_4hr"],
                            initial_value=0.00073807)

sim.set_time_dependent_BC("NH3","4hr","550C",
                            time_value_pairs=data_tup["NH3_4hr"],
                            initial_value=0)

sim.set_time_dependent_BC("NO","4hr","550C",
                            time_value_pairs=data_tup["NO_4hr"],
                            initial_value=0)

sim.set_time_dependent_BC("NO2","4hr","550C",
                            time_value_pairs=data_tup["NO2_4hr"],
                            initial_value=0)

sim.set_const_BC("N2O","4hr","550C",0)

sim.set_const_BC("N2","4hr","550C",0.0184)


# ---------------- 8hr BCs ------------------
sim.set_time_dependent_BC("O2","8hr","550C",
                            time_value_pairs=data_tup["O2_8hr"],
                            initial_value=0.001480842)

sim.set_time_dependent_BC("H2O","8hr","550C",
                            time_value_pairs=data_tup["H2O_8hr"],
                            initial_value=0.00073807)

sim.set_time_dependent_BC("NH3","8hr","550C",
                            time_value_pairs=data_tup["NH3_8hr"],
                            initial_value=0)

sim.set_time_dependent_BC("NO","8hr","550C",
                            time_value_pairs=data_tup["NO_8hr"],
                            initial_value=0)

sim.set_time_dependent_BC("NO2","8hr","550C",
                            time_value_pairs=data_tup["NO2_8hr"],
                            initial_value=0)

sim.set_const_BC("N2O","8hr","550C",0)

sim.set_const_BC("N2","8hr","550C",0.0184)


# ---------------- 16hr BCs ------------------
sim.set_time_dependent_BC("O2","16hr","550C",
                            time_value_pairs=data_tup["O2_16hr"],
                            initial_value=0.001480842)

sim.set_time_dependent_BC("H2O","16hr","550C",
                            time_value_pairs=data_tup["H2O_16hr"],
                            initial_value=0.00073807)

sim.set_time_dependent_BC("NH3","16hr","550C",
                            time_value_pairs=data_tup["NH3_16hr"],
                            initial_value=0)

sim.set_time_dependent_BC("NO","16hr","550C",
                            time_value_pairs=data_tup["NO_16hr"],
                            initial_value=0)

sim.set_time_dependent_BC("NO2","16hr","550C",
                            time_value_pairs=data_tup["NO2_16hr"],
                            initial_value=0)

sim.set_const_BC("N2O","16hr","550C",0)

sim.set_const_BC("N2","16hr","550C",0.0184)
...
sim.print_kinetic_parameter_info(file_name="550C_opt_params.txt")
sim.save_model_state(file_name="550C_model.json")
