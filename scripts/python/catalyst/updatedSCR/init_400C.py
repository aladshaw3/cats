...
T = 400 + 273.15
Tstr = "400C"
O2 = 0.00181082201282586
H2O = 0.000902536109168929
...
sim.ignore_weight_factor("NH3","Unaged",Tstr,time_window=(83,150))
sim.ignore_weight_factor("NO","Unaged",Tstr,time_window=(83,150))
sim.ignore_weight_factor("NO2","Unaged",Tstr,time_window=(83,150))
sim.ignore_weight_factor("N2O","Unaged",Tstr,time_window=(83,150))

sim.ignore_weight_factor("NH3","2hr",Tstr,time_window=(95,150))
sim.ignore_weight_factor("NO","2hr",Tstr,time_window=(95,150))
sim.ignore_weight_factor("NO2","2hr",Tstr,time_window=(95,150))
sim.ignore_weight_factor("N2O","2hr",Tstr,time_window=(95,150))

sim.ignore_weight_factor("NH3","4hr",Tstr,time_window=(87,150))
sim.ignore_weight_factor("NO","4hr",Tstr,time_window=(87,150))
sim.ignore_weight_factor("NO2","4hr",Tstr,time_window=(87,150))
sim.ignore_weight_factor("N2O","4hr",Tstr,time_window=(87,150))

sim.ignore_weight_factor("NH3","8hr",Tstr,time_window=(90,150))
sim.ignore_weight_factor("NO","8hr",Tstr,time_window=(90,150))
sim.ignore_weight_factor("NO2","8hr",Tstr,time_window=(90,150))
sim.ignore_weight_factor("N2O","8hr",Tstr,time_window=(90,150))

sim.ignore_weight_factor("NH3","16hr",Tstr,time_window=(90,150))
sim.ignore_weight_factor("NO","16hr",Tstr,time_window=(90,150))
sim.ignore_weight_factor("NO2","16hr",Tstr,time_window=(90,150))
sim.ignore_weight_factor("N2O","16hr",Tstr,time_window=(90,150))
