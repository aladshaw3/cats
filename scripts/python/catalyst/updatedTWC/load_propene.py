...
sim.set_reaction_param_bounds(rxn, "E", bounds=(sim.model.E[rxn].value*0.8, sim.model.E[rxn].value*1.2))
...
#sim.ignore_weight_factor("N2O","A0","T0",time_window=(55,110))
#sim.ignore_weight_factor("NH3","A0","T0",time_window=(55,110))

sim.finalize_auto_scaling()

# Stop at 400 iter if needed
#my_options={'max_iter': 400}
