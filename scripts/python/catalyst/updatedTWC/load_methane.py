...
# NOTE: 01 is the starting point for these
...
sim.set_reaction_param_bounds(rxn, "E", bounds=(sim.model.E[rxn].value*0.2, sim.model.E[rxn].value*1.2))
sim.set_reaction_param_bounds(rxn, "A", bounds=(sim.model.A[rxn].value*0.7, sim.model.A[rxn].value*1.3))
