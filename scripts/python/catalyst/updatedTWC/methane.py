...
# Can make it to 70 without issue
time_list = time_point_selector(data["time"], data, end_time=100)
...
# HC oxidation
# CxHyOz + (x + (y/4) - (z/2)) O2 --> x CO2 + (y/2) H2O
# {"A": 2.189916847226846e+33, "E": 284704.19832103234}
r3 = {"parameters": {"A": 2.189916847226846e+26, "E": 284704.19832103234},
...
# HC Steam Reforming
# CxHyOz + x H2O --> x CO + (x + (y/2)) H2 + (z/2) O2
#   {"A": 1.8429782328496848e+17, "E": 136610.55181420766}
r12 = {"parameters": {"A": 1.8429782328496848e+10, "E": 136610.55181420766},
...
# HC NO reduction
# CxHyOz + (2x + (y/2) - z) NO --> x CO2 + (y/2) H2O + (x + (y/4) - (z/2)) N2
# {"A": 1.8195374337544053e+19, "E": 131893.1233313617}
r10 = {"parameters": {"A": 1.8195374337544053e+12, "E": 131893.1233313617},
