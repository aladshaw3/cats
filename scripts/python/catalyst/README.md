...
&epsilon;<sub>b</sub> &‌middot; &part;C<sub>b</sub>/&part;t + &epsilon;<sub>b</sub> v &part;C<sub>b</sub>/&part;z = -(1-&epsilon;<sub>b</sub>) G<sub>a</sub> k<sub>m</sub> (C<sub>b</sub> - C)
