...
### Example simulates the 1.08 M Total Vanadium condition from the following references
#
...
[AuxKernels]
  ...
  [./recycle_calc]
      ...
      flow_rate = flow_rate_per_cell  # cm^3/min
      xsec_area = 125 # cm^3 => Used as volume here (half total volume)
      porosity = 1
      execute_on = 'initial timestep_begin nonlinear'
  [../]
...
[Postprocessors]
  ...
  # NOTE: This is the voltage term reported in literature.
  [./phi_s_pos_collector_BC_positive_side_voltage]
