...
/// DGThermalConductivity class object inherits from DGVariableDiffusion object
...
class DGThermalConductivity : public DGVariableDiffusion
{
public:
  ...
  DGThermalConductivity(const InputParameters & parameters);
...
protected:
  ...
  const VariableGradient & _grad_temp_neighbor;
