 ...
 *    \details This file creates a standard MOOSE kernel that is to be used in conjunction with the DGPhaseThermalConductivity kernel
 ...
 *            the DGPhaseThermalConductivity kernel.
 *
...
/// GPhaseThermalConductivity class object inherits from GThermalConductivity object
/** This class object inherits from the GThermalConductivity object in the MOOSE framework.
    ...
    for this object. */
class GPhaseThermalConductivity : public GThermalConductivity
{
public:
    ...
    GPhaseThermalConductivity(const InputParameters & parameters);
