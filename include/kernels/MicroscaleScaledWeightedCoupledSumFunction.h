...
/** This class object inherits from the ScaledWeightedCoupledSumFunction object in the MOOSE framework.
    ...
    This is to be used specifically wit the Microscale set of kernels for intra-particle/-layer
    diffusion and so includes nodal information associated with those methods. You must repeat
    this kernel for every interior node where these physics occur. */
