...
protected:
  ...
  std::vector<Real>
      _binary_coef; ///< Paired Langmuir Coefficients for the coupled variables (units are inverse concentration)
  ...
  std::vector<const VariableValue *>
      _coupled_i; ///< Pointer list to the coupled gases (concentration units)
  std::vector<unsigned int>
      _coupled_i_vars; ///< Indices for the concentration species in the system
  std::vector<const VariableValue *>
      _coupled_j; ///< Pointer list to the coupled gases (concentration units)
  std::vector<unsigned int>
      _coupled_j_vars; ///< Indices for the concentration species in the system
