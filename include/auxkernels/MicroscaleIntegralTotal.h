...
protected:
  ...
  Real
      _space_factor; ///< Conversion factor for space (in cartesian --> face area, in cylindrical --> length, in sphere = 1)
  ...
  /*** WARNING:  This method assumes that the variables are in nodal order from lowest node to
   * highest node! */
