...
private:
  ...
  const VariableValue &
      _eleckin_perm; ///< Variable for the electrokinetic permeability of the membrane (units: Length^2)
  const VariableValue &
      _ion_conc; ///< Variable for the ion concentration in the membrane (units: Moles per Volume)
  ...
  very strange...
              ...
              1 kPa = 1000 J/m^3 * 1 m^3/100^3 cm^3 == 0.001 J/cm^3   ==> Thus, _conv_factor = 0.001
  kPa*cm^3/J
  ...
  be same units as viscosity, the Volume should use same volume units in ion_conc, and the Energy
  unit should use same energy basis in the potential variable (phi).
  **/
