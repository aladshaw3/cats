...
/// SimpleFluidFlatSurfaceMassTransCoef class object inherits from SimpleFluidPropertiesBase object
class SimpleFluidFlatSurfaceMassTransCoef : public SimpleFluidPropertiesBase
{
public:
    ...
    SimpleFluidFlatSurfaceMassTransCoef(const InputParameters & parameters);
