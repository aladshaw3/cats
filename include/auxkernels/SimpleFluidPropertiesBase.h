...
protected:
    ...
    const VariableValue & _vel_x;                     ///< Variable for the linear velocity in x (m, cm, mm) & (hr, min, s)
    const VariableValue & _vel_y;                     ///< Variable for the linear velocity in y (m, cm, mm) & (hr, min, s)
    ...
    Real _eff_diff_factor;                            ///< Factor for porosity to calculate effective diffusivity (default=1.5) [1,2]
    ...
    std::string _mu_pressure_unit;                    ///< Units of the pressure term in the pre-exponential viscosity term (kPa, Pa, mPa)
    std::string _mu_time_unit;                        ///< Units of the time term in the pre-exponential viscosity term (hr, min, s)
    Real _mu_B;                                       ///< Value of the B term in the viscosity function (K)
    Real _mu_C;                                       ///< Value of the C term in the viscosity function (K)

    const VariableValue & _ionic_strength;            ///< Variable for the ionic strength of fluid [Units: moles / volume]
    std::string _ion_volume_unit;                     ///< Units of the volume in the ionic strength variable (L, m^3 (or kL), cm^3 (or mL))
    ...
    std::string _rho_volume_unit;                     ///< Units of the volume in the density reference variable (L, m^3 (of kL), cm^3 (or mL))
