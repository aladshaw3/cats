...
/// SimpleGasFlatSurfaceMassTransCoef class object inherits from SimpleGasPropertiesBase object
class SimpleGasFlatSurfaceMassTransCoef : public SimpleGasPropertiesBase
{
public:
  ...
  SimpleGasFlatSurfaceMassTransCoef(const InputParameters & parameters);
